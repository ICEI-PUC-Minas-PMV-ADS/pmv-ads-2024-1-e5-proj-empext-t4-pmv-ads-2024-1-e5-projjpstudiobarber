...
class BarberController extends Controller
{
    ...
    */
    ...
    public function setAppointment($id, Request $request) {
        ...
        // 1. verifica se o serviço para o barbeiro existe
        ...
        if($barberservice) {
            ...
            if(strtotime($apDate) > 0) {
                // 3. verifica se o barbeiro já está ocupado
                $apps = UserAppointment::select()
                    ->where('id_barber', $id)
                    ->where('ap_datetime', $apDate)
                ->count();
                if($apps === 0) {
                    // 4. Verifica se o barbeiro atende na data informada
                    ...
                    ->first();
                    if($avail) {
                        //4.1 verificar se o barbeiro atende na hora informada
